...
class ForeignObjectRenderer extends Renderer {
    ...
    async render(element) {
        const svg = createForeignObjectSVG(this.options.size.width * this.options.scale, this.options.size.height * this.options.scale, this.options.scale, this.options.scale, element);
...
export { HTML2CanvasClass, html2canvas as default };
